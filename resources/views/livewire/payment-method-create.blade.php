...
@slot('js')
    ...
    <script>
        /* Ejecutamos la funcion stripe al inicio para que permita cargar los estilos */
        document.addEventListener('livewire:load', function(){
            stripe();
        });


        /* Con este script escuchamos el evento que viene del componente una vez se haya hecho algo*/
        ...
        <script>
            function stripe(){
                ...
                cardForm.addEventListener('submit', async (e) => {
                    ...
                    if (error) {
                        /* En caso de que ocurra un error, se lo mostramos al usuario */
                        document.getElementById('cardErrors').textContent = error.message;
                    } else {
                        /* Emitimos un evento para que lo recive livewire */
